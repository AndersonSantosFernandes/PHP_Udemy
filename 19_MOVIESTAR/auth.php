            ...
            <div class="col-md-4" id="register-container">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="lastname" class="form-control" id="lastname" placeholder="Digite seu sobrenome">
                    </div>
                    <div class="form-group">
                        <label for="password">Senha</label>
                        <input type="password" name="password" class="form-control" id="password" placeholder="Digite sua senha">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirmpassword" class="form-control" id="confirmpassword" placeholder="Repita sua senha">
                    </div>
